...
Vec directedRadiance(const Vec &, const Vec &, const Sphere&, int, bool);
...
Vec directedRadiance(const Vec &x, const Vec &o, const Sphere& obj, int depth, bool flag) {
    return Vec();
...
Vec indirectedRadiance(const Vec &x, const Vec &o, const Sphere& obj, int depth, bool flag) {
    ...
    // return reflectedRadiance(x, o, obj, depth+1, flag).mult(brdf.eval(n, o, i)) * n.dot(i) * (1/(pdf*p));

}

Vec reflectedRadiance(const Vec &x, const Vec &o, const Sphere& obj, int depth, bool flag) {

    return directedRadiance(x, o, obj, depth, flag) + indirectedRadiance(x, o, obj, depth, flag);
